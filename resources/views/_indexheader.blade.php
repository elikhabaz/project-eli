<header class="max-w-xl mx-auto mt-20 text-center">
    ...
    <!--  Category -->
                <div class="relative flex lg:inline-flex items-center bg-gray-100 rounded-xl">
                        ...
                        <button @click="show = !show" class="py-2 pl-3 pr-9 text-sm  font-semibold bg-gray-100 lg:w-32 text-left flex lg:inline-flex w-full rounded-xl" >
                            category
                        ...
                        <div x-show="show" class="py-2 absolute bg-gray-100 text-left mt-2 rounded-xl w-full z-50" style="display:none">
